...
2. **Install dependencies**
   ...
   During `npm install`, three deprecation warnings may appear:
   ...
   These warnings come from **transitive dependencies** in the Jest testing ecosystem. They cannot be resolved without breaking changes or waiting for upstream updates. Since they only affect dev dependencies, they pose **no risk to production code**.
   :::
